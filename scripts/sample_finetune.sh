...
# use running stats
python sample.py \
--dataset I128_hdf5 --data_root "/data/ILSVRC128.hdf5" --parallel --shuffle  --num_workers 8 --batch_size 128 \
...
--skip_init --G_batch_size 512 --use_ema --G_eval_mode --sample_trunc_curves 0.1_0.3_0.4  \
--sample_inception_metrics --sample_npz --sample_num_npz 5000 --sample_sheets --sample_random \
--weights_root "./weights/pretrained" \
